...
<head>
  ...
  { alert(resp);
    ...
    xmml.open("GET","check2otp.php?result="+str+"&mobilenum="+mobilenum,true);
    xmml.send();
...
<body>
 ...
 <div id="signupfp">
      ...
      <div style="margin-left: 50px;"><input required id="mobile_boxp" onfocusout="checkmobile()" name="mobile" placeholder="Mobile No."></div><br>
